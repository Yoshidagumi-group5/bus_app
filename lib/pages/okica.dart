              ...
              child: LimitedBox(
                ...
                child: Container(
                    ...
                    child: ListView(
                      shrinkWrap: true,
                      children: const [
                        History("2024/04/01", "沖縄高専入口", "名護十字路"),
                        History("2024/03/25", "沖縄高専入口", "那覇空港"),
                        History("2023/11/20", "沖縄高専入口", "東風平"),
                        History("2023/10/15", "沖縄高専入口", "伊良皆"),
                        History("2023/09/12", "沖縄高専入口", "赤崎"),
                        History("2023/04/01", "沖縄高専入口", "世冨慶"),
                        History("2023/02/25", "沖縄高専入口", "大南"),
                        SizedBox(
                          height: 15,
                        )
                      ],
